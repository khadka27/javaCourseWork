...
<aside id="default-sidebar" class="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full transition-transform sm:translate-x-0" aria-label="Sidebar">  <div class="h-full overflow-y-auto bg-gray-50 px-3 py-4 dark:bg-gray-800">
    <ul class="space-y-2 font-medium">
      ...
      <li>
        <a href="#" id="manage-products-link" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
          ...
          <span class="ms-3 flex-1 whitespace-nowrap">Manage Products</span>
        </a>
      </li>
      <li>
        <a href="#" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
...
<div id="content" class="relative overflow-x-auto shadow-md sm:rounded-lg ml-64 hidden"> <!-- Adjust ml-64 to match the width of the sidebar -->
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    Premium laptop with high performance.
                </td>
                <td class="px-6 py-4">
